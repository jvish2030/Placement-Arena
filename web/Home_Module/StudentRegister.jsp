...
<s:form id="studentRegForm1" enctype="multipart/form-data" action="studentregister.action"  method="post" theme="bootstrap" >
    <div class="row">
        <div class="col-md-4 ">
    ...
    <div class="row">
        ...
        <div class="col-md-4 ">
            <s:textfield name = "sscPercentage"  placeholder="Percentage"/>
        </div>
    </div>
    <div class="section-title pb-0 pt-1 text-sm-start">
        <h6>HSC Details</h6>
    ...
    <div class="row">
        <div class="col-md-4 ">
            <s:select name = "hscPassingYear"
                      headerKey=""
                      emptyOption="true" 
                      headerValue="Passing year"
                      list="{'2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025','2026','2027','2028','2029','2030','2031','2032','2033','2034','2035','2036','2037','2038','2039','2040'}" 
                      />                         
        </div>
        <div class="col-md-4 ">
            <s:select name = "hscBoard"  headerKey="" emptyOption="true" headerValue="Select Board"
                      list="{'STATE','CBSE','ICSE','Others'}" />                         
        </div>
        <div class="col-md-4 ">
            <s:textfield name = "hscPercentage" placeholder="Percentage"/>
        </div>
    </div>
  

    <div class="section-title pb-0 pt-1 text-sm-start ">
        <h6>First semester Details-</h6>
    </div>
    <div class="row">
        <div class="col-md-4 ">
            <s:textfield name = "firstSemMarksObtain" type="number"  placeholder="Marks Obtained"/>
        </div>
        <div class="col-md-4 ">
            <s:textfield name = "firstSemTotalMarks" type="number"  placeholder="Total Marks"/>

        </div>
        <div class="col-md-4 ">
            <s:textfield name = "firstSemPercentage" type="number"  placeholder="Percentage"/>
        </div>
    </div>
    <div class="section-title pb-0 pt-1 text-sm-start ">
        <h6>Second semester Details-</h6>
    </div>
    <div class="row">
        <div class="col-md-4 ">
            <s:textfield name = "secondSemMarksObtain" type="number"  placeholder="Marks Obtained"/>
        </div>
        <div class="col-md-4">
            <s:textfield name = "secondSemTotalMarks" type="number" placeholder="Total Marks"/>

        </div>
        <div class="col-md-4">
            <s:textfield name = "secondSemPercentage" type="number" placeholder="Percentage"/>
        </div>
    </div>
    <div class="section-title pb-0 pt-1 text-sm-start ">
    ...
    <div class="row">
        <div class="col-md-6 mb-2">
            ...
            <div class="row">
                <div class="col-md-6 mb-1">
                    <s:select name = "firstSemActiveBacklog"  headerKey="" emptyOption="true"  headerValue=" Select Active Backlog"
                              list="{'0','1','2','3','4','5','6'}" />   
                </div>
                <div class="col-md-6 ">            
                    <s:select name = "firstSemBacklogHistory" headerKey="" emptyOption="true" headerValue=" Select Backlog history"
                              list="{'0','1','2','3','4','5','6'}" />  
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-2">
            ...
            <div class="row">
                <div class="col-md-6 mb-1">
                    <s:select name = "secondSemActiveBacklog"  headerKey="" emptyOption="true"  headerValue=" Select Active Backlog"
                              list="{'0','1','2','3','4','5','6'}" />   
                </div>
                <div class=" col-md-6">
                    <s:select name = "secondSemBacklogHistory"  headerKey="" emptyOption="true"  headerValue=" Select Backlog history"
                              list="{'0','1','2','3','4','5','6'}" />  
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function val() {
        ...
        {
            /* get file size in MB */
            var file_size1 = $('#file1')[0].files[0].size / 1024 / 1024;
            var file_size2 = $('#file2')[0].files[0].size / 1024 / 1024;
